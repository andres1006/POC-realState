...
export declare type RadioButtonOverridesProps = {
    RadioButton?: PrimitiveOverrideProps<IconProps>;
} & EscapeHatchProps;
export declare type RadioButtonProps = React.PropsWithChildren<Partial<IconProps> & {
    property1?: "Selected" | "Unselected";
} & {
