...
export default function PropertyUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = propertyRecord
      ...
      : initialValues;
    setNameStreet(cleanValues.nameStreet);
    setBedsQuantity(cleanValues.bedsQuantity);
    setBathroomsQuantity(cleanValues.bathroomsQuantity);
    setDimension(cleanValues.dimension);
    setPriceXMonth(cleanValues.priceXMonth);
